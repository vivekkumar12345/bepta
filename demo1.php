   ...
   <div>
			...
			<div>
				<div>
					...
					<tr>
					<td>
						<input type="text" name="mem_id[]" id="mem_id_1" class="form-control" autocomplete="off" value="<?php session_start(); echo $_SESSION['mem_id']; ?>
						"required>
					</td>
					</tr>
					<tr>
...
$(document).ready(function(){
	...
	$(document).on('click', '#addRows', function() { 
		...
		htmlRows += '<tr><td style="color: black;">'+count+'</td></tr>'; 
		...
		htmlRows += '<tr><td><input type="text" placeholder="Members dont need to fill this field" name="name[]" id="name_'+count+'" class="form-control" autocomplete="off" required></td></tr>';	
