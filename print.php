...
date_default_timezone_set("Asia/Kolkata");
 ...
 echo date("Y-m-d h:i:sa"); ?>
	<center>
	<h1>FN LIST OF BOOKED SLOTS ON <?php echo $_GET['date']; ?> </h1>
 <table border="1" style="border-collapse:collapse;" cellpadding="0" cellspacing="0" width="90%">
 	...
 	<th>
 		...
 		<td style="padding: 1vh 2%;">Time</td>
...
$ser=1;
$sqlsd="select distinct slot from booking where booking_date='".$_GET['date']."' order by slot ASC";
	$querysd=mysqli_query($conn, $sqlsd);
	while($rowsd=mysqli_fetch_assoc($querysd))	{
	    ?>
	    <tr>
<td width="100%" colspan="6" style="padding: 1vh 2%;"> <?php echo $rowsd['slot'];  ?></td>
</tr>
<?php
$sqls="select * from booking where booking_date='".$_GET['date']."' and slot='".$rowsd['slot']."' and slot_time<1200 order by slot_time ASC";
...
<tr style="font-size: 1.5vh; text-align: center;">
	...
	<td width="10%" style="padding: 1vh 2%;"> <?php echo $rows['slot_time'];  ?></td>
...
$ser++;
 ...
 ?>
	...
	<h1>  LIST OF BOOKED SLOTS ON <?php echo $_GET['date']; ?> AN </h1>
 <table border="1" style="border-collapse:collapse;" cellpadding="0" cellspacing="0" width="90%">
